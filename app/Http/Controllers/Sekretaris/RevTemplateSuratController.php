...
{
    private $url = 'sekretaris/rev-template-surat';
    private $views = 'Sekretaris/TemplateSurat';
    ...
    {
       $template = TemplateSuratModel::where('id',$id)->first();
        $data = [
            'title'     => $this->title,
            'page'      => 'Tambah template surat All',
            'url'       => $this->url,
    ...
    public function update(Request $request, string $id)
    {
        ...
        if(isset($request->lampiran)){
            ...
            TemplateSuratModel::where('id', $request->id)->update($data);
        
            return redirect('sekretaris/rev-template-surat')->with('sukses', 'Lampiran berhasil diedit');
        }else{
            $data = [
                // 'lampiran'      => $documentFileName,
    ...
    public function destroy(string $id): RedirectResponse
{
    ...
    return redirect()->route('sekretaris.template-surat.index')->with('sukses', 'Data berhasil dihapus');
}
