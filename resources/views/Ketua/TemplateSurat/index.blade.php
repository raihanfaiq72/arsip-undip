                                    ...
                                    <div class="image view view-first">
                                        ...
                                        <div class="mask">
                                            ...
                                            <div class="tools tools-bottom">
                                                <a href="{{ url('ketua/template-surat'.$p->id, []) }}/edit"><i
                                                        class="fa fa-pencil"></i></a>
                                                <a
                                                    href="{{ route('ketua.template-surat.download', ['id' => $p->id]) }}"><i
                                                        class="fa fa-download"></i></a>
                                                <a href="{{ route('ketua.template-surat.destroy', ['id' => $p->id]) }}"
                                                    onclick="event.preventDefault(); if (confirm('Are you sure you want to delete this item?')) document.getElementById('delete-form').submit();">
                                                    <i class="fa fa-times"></i>
                                                </a>


                                                <form id="delete-form"
                                                    action="{{ route('ketua.template-surat.destroy', ['id' => $p->id]) }}"
